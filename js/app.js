$(function(){
  ...
  var PodcastDetailView = Backbone.View.extend({
    ...
    clicked: function(e){
      ...
      var description = this.findByTitle(title);
      $("#podcast-episode-description").text(description);
    },
